defmodule PermissionRepositoryTest do
    ...
    describe "can_do_this_action/2" do
        test "validate the permission with base in role" do
           ...
           can_create = PermissionRepository.can_do_this_action(%{permission: :can_create, role: "regular"})
           can_delete = PermissionRepository.can_do_this_action(%{permission: :can_delete, role: "regular"})
           can_view = PermissionRepository.can_do_this_action(%{permission: :can_view, role: "regular"})
           can_view_all = PermissionRepository.can_do_this_action(%{permission: :can_view_all, role: "regular"})
        ...
        test "should not be able to validate if insert a invalid role" do
            {:error, invalid_role} = PermissionRepository.can_do_this_action(%{permission: :can_create, role: "rregular"})
        ...
        test "should not be able to validate if insert a invalid permission" do
            {:error, invalid_permission} = PermissionRepository.can_do_this_action(%{permission: :not_create, role: "regular"})
        ...
        test "should not be able to validate if insert a invalid permission and role" do
            {:error, invalid_permission_role} = PermissionRepository.can_do_this_action(%{permission: :not_create, role: "rsegular"})
