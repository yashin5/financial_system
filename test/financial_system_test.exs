defmodule FinancialSystemTest do
  ...
  describe "create/3" do
    ...
    test "User should be able to create a account with float value", %{
    ...
    test "User should be able to create a account with integer value", %{
      account_struct: account_struct
    } do
  ...
  describe "deposit/3" do
    ...
    test "User should be able to insert a integer value in a account", %{account_pid: pid} do
      assert FinancialSystem.deposit(pid, "brl", 1).value == 200
    end

    test "User should be able to insert a float value in a account", %{account_pid: pid} do
      assert FinancialSystem.deposit(pid, "brl", 1.0).value == 200
    end

    test "User not should be able to insert a string value in a account", %{account_pid: pid} do
      assert_raise ArgumentError,
  ...
  describe "withdraw/2" do
    ...
    test "User should be able to take a value of an account", %{account_pid: pid} do
    ...
    test "User not should be able to make the withdraw inserting a string value", %{
      account_pid: pid
    } do
      assert_raise ArgumentError,
                   "The first arg must be a pid and de second arg must be a number",
  ...
  describe "transfer/3" do
    ...
    test "User should be able to transfer value between accounts", %{
  ...
  describe "split/3" do
    ...
    test "User should be able to transfer a value between multiple accounts", %{
      account_pid: pid,
      list: split_list,
      account3_pid: pid3,
      account2_pid: pid2
    ...
    test "User not should be able to make the transfer value 0 or less than 0", %{
      account_pid: pid_from,
      list: split_list
    } do
      assert_raise ArgumentError,
